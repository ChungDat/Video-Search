...
import json
from PATH import KEYFRAMES_PATH, MY_KEYFRAMES_PATH, VIDEOS_PER_PACK_PATH, KEYFRAMES_ROOT
...
def init_session_state():
    ...
    if "available_videos_per_pack" not in st.session_state:
        st.session_state.available_videos_per_pack = json.load(open(VIDEOS_PER_PACK_PATH, 'r'))
